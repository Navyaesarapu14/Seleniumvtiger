...
public class createOrgWithIndustryAndTypeTest {
	...
	import org.testng.asserts.SoftAssert;
		...
		createOrg.selectType(web, get("Type"));
		...
		if(newOrgInfo.getPageHeader().contains(orgName))
			excel.writeToExcel("OrganizationsTestData", "Create Organization With Industry", "Pass"), IConstantPath
		
			else
				excel.writeToExcel("OrganizationsTestData", "Create Organization With Industry",` "Fail"), IConstantPath
				soft.assertAll();
	}
